...
_G.packer_plugins = {
  ...
  fzf = {
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/fzf",
    url = "https://github.com/junegunn/fzf"
  },
  ["fzf.vim"] = {
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/fzf.vim",
    url = "https://github.com/junegunn/fzf.vim"
  },
  ["git-blame.nvim"] = {
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/git-blame.nvim",
  ...
  gruvbox = {
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
